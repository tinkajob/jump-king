...
from platformer_resources.config import *
from platformer_resources.pygame_objects import *
from platformer_resources.objects import *
from platformer_resources.utils import log_in, draw_scene, load_player_stats, save_player_stats
...
while WINDOW_OPEN:
    ...
    while running:
        ...
        if not game_ended:
            draw_scene("running", current_level, delta_time)

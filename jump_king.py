...
while WINDOW_OPEN:
    ...
    while running:
        ...
        if player.can_move:
            level, current_level = player.move(
                delta_time, keys, current_level, level, levels
            )
    ...
    while endscreen:
        ...
        if next_scene == "endscreen" or (
            (next_scene == "main_menu" or next_scene == "quit") and effect.get_active()
        ):
